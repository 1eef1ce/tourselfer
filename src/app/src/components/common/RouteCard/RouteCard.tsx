                    ...
                    <div className={'route-desc-right'}>
                        {label && (
                            <div className="route-mark">
                                ...
                                <defs><linearGradient id="paint0_linear_553_4244" x1="21" y1="23" x2="-0.64712" y2="5.51537" gradientUnits="userSpaceOnUse"><stop stopColor="#0B97A0"></stop><stop offset="1" stopColor="#AEDEA6"></stop></linearGradient></defs>
                                </svg>
                                </div>
